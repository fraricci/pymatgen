...
class BoltztrapPlotter(object):
    ...
    def plot_seebeck_dop(self, temps='all', output='average'):
        ...
        tlist = np.sort(list(sbk['n'].keys())) if temps == 'all' else temps
        plt.figure(figsize=(22, 14))
        for i, dt in enumerate(['n', 'p']):
            plt.subplot(121 + i)
            for temp in tlist:
    ...
    def plot_conductivity_dop(self, temps='all', output='average',
        ...
        tlist = np.sort(list(cond['n'].keys())) if temps == 'all' else temps
        plt.figure(figsize=(22, 14))
        for i, dt in enumerate(['n', 'p']):
            plt.subplot(121 + i)
            for temp in tlist:
    ...
    def plot_power_factor_dop(self, temps='all', output='average',
        ...
        tlist = np.sort(list(pf['n'].keys())) if temps == 'all' else temps
        plt.figure(figsize=(22, 14))
        for i, dt in enumerate(['n', 'p']):
            plt.subplot(121 + i)
            for temp in tlist:
    ...
    def plot_zt_dop(self, temps='all', output='average', relaxation_time=1e-14):
        ...
        tlist = np.sort(list(zt['n'].keys())) if temps == 'all' else temps
        plt.figure(figsize=(22, 14))
        for i, dt in enumerate(['n', 'p']):
            plt.subplot(121 + i)
            for temp in tlist:
    ...
    def plot_eff_mass_dop(self, temps='all', output='average'):
        ...
        tlist = np.sort(list(em['n'].keys())) if temps == 'all' else temps
        plt.figure(figsize=(22, 14))
        for i, dt in enumerate(['n', 'p']):
            plt.subplot(121 + i)
            for temp in tlist:
